"""
공통 질문셋 - 전체 사내 문서 기반
eval.py, custom_ifeval.py, ragas_eval.py 에서 공유
"""
...
QUESTIONS = [
    # ── 법인카드 사용 및 관리 규정 ──────────────────────
    {
        ...
        "out_of_scope": False,
        "checks": ["keyword_match", "has_answer", "terms"],
    },
    {
        "id": "cc02",
        "type": "절차",
        ...
        "category": "corporate-card",
        "out_of_scope": False,
        "checks": ["keyword_match", "has_answer"],
    },
    {
        "id": "cc03",
        "type": "절차",
        ...
        "category": "corporate-card",
        "out_of_scope": False,
        "checks": ["keyword_match", "department", "has_answer"],
    },
    {
        "id": "cc04",
        "type": "일상어",
    ...
    # ── 문서 보존 및 폐기 기준 ──────────────────────────
    {
        "id": "dr01",
        "type": "일상어",
        "question": "일반 업무 문서는 얼마나 보존해야 하나요?",
        "answer_article": "",
        "keyword": "3년",
        "ground_truth": "일반 업무 문서와 회의록은 작성일로부터 3년 동안 보존한다.",
        "department": "general",
    ...
    },
    {
        "id": "ob03",
        "type": "일상어",
        "question": "신규 입사자 멘토는 몇 주 동안 지정되나요?",
        "answer_article": "",
        "keyword": "8주",
        "ground_truth": "각 신규 입사자에게는 첫 8주 동안 온보딩 멘토가 지정된다.",
        "department": "hr",
        "category": "onboarding",
        "out_of_scope": False,
        "checks": ["keyword_match", "has_answer"],
    ...
    # ── 재택근무 운영 규정 ──────────────────────────────
    {
        "id": "rw01",
        "type": "일상어",
        "question": "재택근무는 주 몇 회까지 신청할 수 있나요?",
        "answer_article": "",
        "keyword": "주 2회",
        "ground_truth": "일반 임직원은 주 2회까지 재택근무를 신청할 수 있다.",
        "department": "hr",
    ...
    # ── 업무 기기 보안 규정 ─────────────────────────────
    {
        "id": "ds01",
        "type": "일상어",
        "question": "화면 자동 잠금은 몇 분으로 설정해야 하나요?",
        "answer_article": "",
        "keyword": "10분",
        "ground_truth": "자동 잠금 시간은 10분 이하로 설정한다.",
        "department": "security",
    ...
    },
    {
        "id": "pv03",
        "type": "일상어",
        "question": "파기 완료 기록은 얼마나 보관해야 하나요?",
        "answer_article": "",
        "keyword": "1년",
        "ground_truth": "파기 기록은 최소 1년 동안 보관한다.",
        "department": "security",
        "category": "privacy",
        "out_of_scope": False,
        "checks": ["keyword_match", "has_answer"],
    },
    # ── 범위 외 질문 (Hallucination 테스트) ────────────
    {
        "id": "out01",
        "type": "범위외",
